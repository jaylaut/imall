...
import com.jay.imall.coupon.service.PmsCategoryBrandRelationService;
 ...
 */
@RestController
@RequestMapping("coupon/pmscategorybrandrelation")
public class PmsCategoryBrandRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:pmscategorybrandrelation:list")
   ...
   // @RequiresPermissions("coupon:pmscategorybrandrelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupon:pmscategorybrandrelation:save")
    ...
    //@RequiresPermissions("coupon:pmscategorybrandrelation:update")
    ...
    //@RequiresPermissions("coupon:pmscategorybrandrelation:delete")
