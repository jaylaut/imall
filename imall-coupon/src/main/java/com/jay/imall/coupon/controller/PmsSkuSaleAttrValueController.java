...
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:pmsskusaleattrvalue:list")
   ...
   // @RequiresPermissions("coupon:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupon:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("coupon:pmsskusaleattrvalue:update")
    ...
    //@RequiresPermissions("coupon:pmsskusaleattrvalue:delete")
